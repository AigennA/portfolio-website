                                ...
                                <div class="project-group-videos">
                                    ${child.children.map(videoProj =>
                                        `<div class="video-card">
                                            ...
                                            <iframe src="${videoProj.src}" width="100%" style="aspect-ratio: 16/9; max-width:320px; border-radius: 1rem; border: none; margin:0.5rem 0;" allow="autoplay; fullscreen; encrypted-media; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="project-detail">
                ${
                    project.type === "image"
                        ...
                        : `<iframe src="${project.src}" width="100%" style="aspect-ratio: 16/9; border-radius: 1rem; border: none;" allow="autoplay; fullscreen; encrypted-media; picture-in-picture" allowfullscreen></iframe>`
                }
